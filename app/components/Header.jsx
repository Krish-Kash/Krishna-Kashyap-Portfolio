...
const Header = () => {
  return (
    ...
    items-center justfiy-center gap-4 pt-30'>
      <motion.div
      initial={{scale: 0}}
      whileInView={{scale: 1}}
      transition={{duration: 0.8, type: 'spring', stiffness: 100}}>
        ...
        transition={{duration: 0.6, delay: 0.3}}
         className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            Hi! I'm Krishna Kashyap <Image src={assets.hand_icon} alt=''
        ...
        className='text-3xl sm:text=6xl lg:text-[66px] font-Ovo'>
            ...
            className='max-w-2xl mx:auto font:Ovo'>
                I am a software developer based in India. I have a passion for web development and love to create new things. 
            ...
            (Dark Mode Under Development please use DarkReader
                extension for now!!)
            </motion.p>
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                text-white flex items-center gap-2 dark:bg-black'>
