  ...
  return (
    <>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 
        ...
        ${isScroll ? "bg-white/50 backdrop-blur-lg shadow-sm dark:bg-bg-darkTheme dark:shadow-white/20" : ""}`}>
        <a href="#top">
          <Image src={isDarkMode ? assets.logo : assets.logo} className='w-28 cursor-pointer mr-14' alt="" />
        </a>
        ...
        <div className='flex items-center gap-4'>
          ...
          <a href="#contact" className='hidden lg:flex items-center gap-3 px-10
            py-2.5 border border-gray-500 rounded-full ml-4 bg-white font-Ovo
        ...
        <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64
          ...
          dark:bg-darHover dark:text-white'>
